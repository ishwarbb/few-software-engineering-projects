...
public class UserHandler extends BaseResource {
    ...
    public Response register(
        ...
        ValidationUtil.validateSecurePassword(password, PASSWORD_STRING);
        ...
        try {
            ...
            } else if("AlreadyExistingUsernameAndEmail".equals(e.getMessage())){
                throw new ServerException("AlreadyExistingUsernameAndEmail", "Login already used", e);
            } else if("AlreadyExistingEmail".equals(e.getMessage())){
                throw new ServerException("AlreadyExistingEmail", "Login already used", e);
            }
            else {
