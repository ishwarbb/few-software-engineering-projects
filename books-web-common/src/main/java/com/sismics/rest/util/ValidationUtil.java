...
import com.sismics.rest.util.passwordutil.DigitHandler;
import com.sismics.rest.util.passwordutil.LengthHandler;
import com.sismics.rest.util.passwordutil.LowercaseHandler;
import com.sismics.rest.util.passwordutil.PasswordHandler;
import com.sismics.rest.util.passwordutil.SpecialCharHandler;
import com.sismics.rest.util.passwordutil.UppercaseHandler;
...
public class ValidationUtil {
    ...
    public static void checkRange(Float val, String name, Float lowerLim, Float upperLim) throws JSONException {
        if ((val < lowerLim) || (val > upperLim)) {
            throw new ClientException("ValidationError", MessageFormat.format("{0} must be between {1} and {2}", name, lowerLim, upperLim));
        }
    }
